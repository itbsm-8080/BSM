...
var
  s:string;
  i,isaktif,isfocus,isstok,isexpired : integer;
  tt:TStrings;
...
if FLAGEDIT then
  s:='update tbarang set '
    ...
    + ' brg_isproductfocus=  ' + IntToStr(isfocus) + ','
...
begin
  ...
  s :=  ' insert into tbarang '
             ...
             + ' brg_hrgjual,brg_hrgbeli,brg_isaktif,brg_isproductfocus,brg_isstok,brg_isexpired,date_create,user_create'
             + ' ) '
             + ' values ( '
             + Quot(edtKode.Text) + ','
             + Quot(edtNama.Text) + ','
