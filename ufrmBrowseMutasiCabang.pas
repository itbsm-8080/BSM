...
//      ShowForm(TfrmBrowseBarang).Show;
      ...
      frmMutasiCabang.loaddataALL(CDSMaster.FieldByname('Nomor').AsString, CDSMaster.FieldByname('Tujuan').AsString);
