...
begin
  ...
  + ' (select sum(jurd_debet-jurd_kredit) from tjurnalitem inner join trekening '
  + ' on rek_kode=jurd_rek_kode inner join tjurnal on jur_no=jurd_jur_no '
  + ' where jurd_rek_kode=a.rek_kode and jur_tanggal <= '+QuotD(startdate.Date)+' and rek_kol_id=1) Saldo_Akhir '
