...
begin
  ssql := 'select 1 no,rek_nama Keterangan,'
        ...
        ssql := 'select month(jur_tanggal) bulan,'
            ...
            + ' and month(jur_tanggal)<='+ IntToStr(cbbBulan2.ItemIndex+1)
        ...
        begin
          try
            ...
            begin
              for i := cbbBulan.ItemIndex+1 to cbbBulan2.ItemIndex+1 do
              begin
                If ds3.State <> dsEdit then ds3.Edit;
...
function TfrmLapLabaRugi.GetCDSPabrik: TClientDataset;
var s:String;
begin
...
procedure TfrmLapLabaRugi.FormCreate(Sender: TObject);
begin
