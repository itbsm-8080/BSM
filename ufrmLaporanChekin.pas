...
type
  TfrmLaporanChekin = class(TfrmCxBrowse)
...
var
  frmLaporanChekin: TfrmLaporanChekin;
...
procedure TfrmLaporanChekin.btnRefreshClick(Sender: TObject);
var
...
procedure TfrmLaporanChekin.FormShow(Sender: TObject);
begin
...
procedure TfrmLaporanChekin.cxButton6Click(Sender: TObject);
begin
  inherited;
  refreshdata;
end;
