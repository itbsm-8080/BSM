...
begin
  ...
  begin
    ...
    zAddField(FCDS, 'NIK', ftString, False,20);
    zAddField(FCDS, 'unit', ftString, False,80);    
    FCDS.CreateDataSet;
  end;
  Result := FCDS;
end;
...
procedure TfrmPenerimaanLain.clSupplierPropertiesButtonClick(
...
function TfrmPenerimaanLain.cekkembar(akode:string;amemo:String;abaris:Integer):Boolean;
var
  s:string;
  i:Integer;
begin
...
procedure TfrmPenerimaanLain.cxButton3Click(Sender: TObject);
var
  s:String;
  tsql:TmyQuery;
  i:integer;
...
function TfrmPenerimaanLain.getunitbisnis(anik:string):string;
var
  s:string;
  tsql:TmyQuery;
begin
...
procedure TfrmPenerimaanLain.clNikPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
 var
    s:string;
    tsql:TmyQuery;
...
procedure TfrmPenerimaanLain.cxButton4Click(Sender: TObject);
var
  s:String;
  tsql:TmyQuery;
  i:integer;
