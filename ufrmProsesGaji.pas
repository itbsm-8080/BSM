...
uses
  ...
  AdvCombo, dxSkinBlack, dxSkinBlue, dxSkinCaramel, dxSkinCoffee,
  ...
  begin
   ...
   begin
        s:='insert into tgajibulanan '
          ...
          + ' gb_kompetensi,gb_tunjanganjabatan,gb_bpjs,gb_bpjstk,gb_koperasi,gb_angsuran,'
          + ' gb_punishment,gb_harikerja,'
          + ' gb_sewakendaraan,gb_luarkota,gb_jabatan,gb_lainlain,gb_tunjanganmakan,gb_jmlharipot,gb_tidakmasuk) values ( '
          ...
          +  floatToStr(CDS.FieldByName('jmlharipot').Asfloat)+','
          +  floatToStr(CDS.FieldByName('tidakmasuk').Asfloat)
          +');';
       tt.Append(s);
     end;
     CDS.next;
...
begin
  ...
  begin
    ...
    zAddField(FCDS, 'potharikerja', ftfloat, False);
    ...
    zAddField(FCDS, 'jmlharipot', ftfloat, False);
    zAddField(FCDS, 'tidakmasuk', ftfloat, False);    
    FCDS.CreateDataSet;
  end;
  Result := FCDS;
end;
        ...
        begin
         ...
         begin
                   ...
                   cds.Append;
                    ...
                    CDS.FieldByName('gapok').AsString := floattostr(cstrtoFloat(Excel.Cells[6+i,6].text));
                    CDS.FieldByName('kompetensi').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,8].text));;
                    CDS.FieldByName('tjabatan').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,7].text));
                    CDS.FieldByName('tmakan').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,19].text));
                    CDS.FieldByName('sewa').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,19].text));
                    CDS.FieldByName('bpjs').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,16].text));
                    CDS.FieldByName('bpjstk').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,15].text));
                    CDS.FieldByName('Koperasi').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,14].text));
                    CDS.FieldByName('angsuran').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,13].text));
                    CDS.FieldByName('Punishment').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,10].text));
                    CDS.FieldByName('HariKerja').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,12].text));
                    CDS.FieldByName('Total').AsString :=floattostr((cstrtoFloat(Excel.Cells[6+i,6].text)+cstrtoFloat(Excel.Cells[6+i,7].text)+cstrtoFloat(Excel.Cells[6+i,8].text)+cstrtoFloat(Excel.Cells[6+i,9].text))-
                    (cstrtoFloat(Excel.Cells[6+i,10].text)+cstrtoFloat(Excel.Cells[6+i,11].text)+cstrtoFloat(Excel.Cells[6+i,12].text)+cstrtoFloat(Excel.Cells[6+i,13].text)+cstrtoFloat(Excel.Cells[6+i,14].text)+cstrtoFloat(Excel.Cells[6+i,15].text)+cstrtoFloat(Excel.Cells[6+i,16].text)));
                    CDS.FieldByName('jabatan').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,5].text));
                    CDS.FieldByName('potHarikerja').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,12].text));
                    CDS.FieldByName('lain').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,9].text));
                    CDS.FieldByName('jmlharipot').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,11].text));
                    CDS.FieldByName('tidakmasuk').AsString :=floattostr(cstrtoFloat(Excel.Cells[6+i,17].text));
...
var
  ...
  i:Integer;
begin
  s := ' select *,((gb_gapok+gb_tunjanganjabatan+gb_tunjanganmakan+gb_lainlain+gb_kompetensi)-(gb_bpjs+gb_bpjstk+gb_koperasi+gb_angsuran)) total from tgajibulanan where'
       ...
       begin
            ...
            while  not Eof do
             begin
                    ...
                    CDS.FieldByName('tidakmasuk').AsString :=Fieldbyname('gb_tidakmasuk').AsString;
                    CDS.FieldByName('jmlharipot').AsString :=Fieldbyname('gb_jmlharipot').AsString;
  ...
  try
    ...
    ftsreport.Nama := 'Gajian';
          ...
          s:= 'select '
            ...
            + ' a.* ,'
            + ' terbilang((gb_gapok+gb_tunjanganmakan+gb_tunjanganjabatan+gb_kompetensi+gb_lainlain+gb_sewakendaraan)-(gb_bpjs+gb_bpjstk+gb_koperasi+gb_angsuran+gb_punishment+gb_harikerja+(gb_tidakmasuk*gb_lainlain/25))) bilang'
            + ' from tgajibulanan a'
